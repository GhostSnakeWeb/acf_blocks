    ...
    <div class="aw-info-card-in-hero__container">
        ...
        <div class="aw-info-card-in-hero__content">
            <div class="aw-info-card-in-hero__left">
                <? if (!empty($demo)): ?>
                    <? if (!empty($demo['placeholder'])): ?>
                        <div class="aw-slot-demo">
                            <div class="aw-info-card-in-hero__left-play-free-bg"
                                 style="--demo-placeholder: url('<?=$demo['placeholder']['url'];?>');"
                            >
<!--                                <img class="aw-info-card-in-hero__left-play-free-image"-->
<!--                                     src="--><?//=$demo['placeholder']['sizes']['info-card-in-hero-demo-placeholder'];?><!--"-->
<!--                                >-->
                                <div
                                    class="aw-info-card-in-hero__left-play-free-circle"
                                    style="background-image: url(<?=$demo['placeholder']['url'];?>);"
                                >
                                </div>
                                <img
                                    class="aw-info-card-in-hero__left-play-free-button"
                                    src="<?=get_template_directory_uri() . '/assets/img/hero/review-slot/play-free-button.svg';?>"
                                    alt="Play Free Button"
                                >
                                <span><?=__("Play free");?></span>
                            </div>
                        </div>
                    <? endif; ?>
                    <? if (!empty($demo['iframe'])): ?>
                        <div class="iframe-response none">
                            <iframe src="" data-src="<?=$demo['iframe'];?>"></iframe>
                        </div>
	                <? endif; ?>
                <? endif; ?>
